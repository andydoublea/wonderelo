    ...
    <div className="container mx-auto p-6 max-w-4xl flex-1">
      ...
      {loading ? (
        ...
        <>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <h3 className="text-lg font-semibold">Unlimited events</h3>
          ...
          {/* Invoices & Credit history */}
          <Card className="mb-8">
            <CardHeader>
              <div style={{ display: 'flex', gap: '0', borderBottom: '1px solid var(--border)' }}>
                <button
                  type="button"
                  onClick={() => onInvoicesTabChange('invoices')}
                  style={{
                    padding: '8px 16px',
                    fontSize: '14px',
                    fontWeight: 500,
                ...
                {creditTransactions.length > 0 && (
                  <button
                    type="button"
                    onClick={() => onInvoicesTabChange('credits')}
                    style={{
                      padding: '8px 16px',
                      fontSize: '14px',
                      fontWeight: 500,
                  ...
                  <div>
                    ...
                    {invoiceEmailEditing ? (
                      <div className="flex items-center gap-2" style={{ marginTop: '4px' }}>
                        <input
                          ...
                          onKeyDown={(e) => {
                            ...
                            if (e.key === 'Escape') {
                              onInvoiceEmailEditingChange(false);
                              onInvoiceEmailChange(billingDetails.email || '');
                            }
                          }}
                          autoFocus
                        />
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => onInvoiceEmailEditingChange(true)}
