/* Wonderelo — shared public-site footer (Claude Design `.w-footer`).
   Ported from design/v07/project/pages (matches the Homepage FooterSection).
...
const SOCIALS: Array<{ label: string; path: string }> = [
  { label: 'X', path: 'M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84' },
...
export function PublicFooter() {
  ...
  return (
    <footer className="w-footer" data-screen-label="Public / Footer">
      <div className="w-footer-inner">
        <div className="w-footer-grid">
          <div className="w-foot-brand">
            <div className="w-foot-logo">
              ...
              <span className="w-word">wonderelo</span>
            </div>
          </div>
          ...
          <div className="w-foot-col">
            ...
            <ul>
              ...
              <li><a className="w-foot-link" href="#" onClick={go('/blog')}>Newsroom</a></li>
              <li><a className="w-foot-link" href="mailto:hello@wonderelo.com">Contact us</a></li>
            </ul>
          </div>
          <div className="w-foot-col">
            <h5>Support</h5>
        ...
        <div className="w-foot-bottom">
          <span>© 2026 Wonderelo. All rights reserved.</span>
          <div className="w-foot-social">
            {SOCIALS.map((s) => (
