...
import { X, Image as ImageIcon, Loader2, Plus, Video, Building2, Check, ChevronUp, ChevronDown } from 'lucide-react';
          ...
          {normalizedPoints.map((point, index) => (
            <div key={point.id}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                {/* HIDDEN to match design (plain name list only). Logic preserved.
                    Type toggle / video link / photo upload are guarded off. */}
                {false && (<>
