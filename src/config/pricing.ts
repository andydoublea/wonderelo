...
// All prices in EUR cents, excl. VAT
...
export interface PricingTier {
  capacity: number;
  tier: CapacityTier;
  singleEventPrice: number; // in EUR cents
  premiumMonthlyPrice: number; // in EUR cents
  premiumAnnualPrice: number; // in EUR cents (per year)
}
